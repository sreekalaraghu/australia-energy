        ...
        <div className='navbar'>
            ...
            <GiAustralia /> Energy
                ...
                <ul className={nav ? 'nav-menu active' : 'nav-menu'}>
                    ...
                    <li><a href="/"><Link onClick={handleClose} activeClass="active" to="handling" spy={true} smooth={true} duration={500}>StoryPanel</Link></a></li>
                    <li><a href="/"><Link onClick={handleClose} activeClass="active" to="options" spy={true} smooth={true} duration={500}>Explore</Link></a></li>
                    <li><a href="/"><Link onClick={handleClose} activeClass="active" to="teams" spy={true} smooth={true} duration={500}>Teams</Link></a></li>
